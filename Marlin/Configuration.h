 ...
 *
 * Based on Sprinter and grbl. Edited by me : )
...
//#define ELECTROMAGNETIC_SWITCHING_TOOLHEAD
  ...
  #define SWITCHING_TOOLHEAD_X_POS          { 215, 0 }  // (mm) X positions for parking the extruders
    ...
    //#define PRIME_BEFORE_REMOVE                       // Prime the nozzle before release from the dock
      ...
      #define SWITCHING_TOOLHEAD_RETRACT_FEEDRATE  240  // (mm/min) Extruder retract feedrate
    #endif
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.0, 80.6, 405, 1040.0 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1200, 1200, 350, 70 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 600, 600, 10, 500 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -65.5, 26.5, -0.9 }
...
#define HOMING_FEEDRATE_MM_M { 100*60, 100*60, 200 }
